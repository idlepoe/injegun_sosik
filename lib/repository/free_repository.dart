...
/// Firestore articles 컬렉션 중 type=='free' GET 전용 (페이징)
class FreeRepository implements ArticleRepository {
  FreeRepository({FirebaseFirestore? firestore})
  ...
  Future<FreePageResult> getPage({
    ...
    return FreePageResult(items, lastDoc);
  }
}

/// 한 페이지 조회 결과 (리스트 + 커서)
class FreePageResult {
  FreePageResult(this.items, this.lastDoc);
